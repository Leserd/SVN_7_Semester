   ...
   SubShader {
      Pass {      
         ...
         void main()
         {
            ...
            // default: unlit  vec3 fragmentColor = vec3(_UnlitColor); 
            ...
            if (dot(viewDirection, normalDirection)  < mix(_UnlitOutlineThickness, _LitOutlineThickness, max(0.0, dot(normalDirection, lightDirection))))
            {
               fragmentColor = 
